				   ...
				   <view class="timeWarpper">
						...
						<u-form-item label="公司" 	borderBottom ref="item1" labelWidth='80' @click='pickerShow=true'>
							...
							<u-form-item label="开始日期" 	borderBottom ref="item1" labelWidth='80' @click='pickerStartTime=true'>
								<u--input
														v-model="$moment(form.startTime).format('YYYY-MM-DD')"
														disabled
														disabledColor="#ffffff"
														placeholder="请选择开始日期"
														border="none"
							...
							<u-form-item label="结束日期" 	borderBottom ref="item1" labelWidth='80' @click='pickerEndTime=true'>
								<u--input
														v-model="$moment(form.endTime).format('YYYY-MM-DD')"
														disabled
														disabledColor="#ffffff"
														placeholder="请选择结束日期"
														border="none"
	...
	export default {
		data() {
			return {
				...
				search:'',
				rawdata:'',
				form:{startTime:this.$moment().format('YYYY-MM-01'),endTime:this.$moment().format('YYYY-MM-DD'),zh:'',label:'所有'},
				startDate:false,
				startDateValue:'',
				companyList:[
					{id:'',label:'所有'},
